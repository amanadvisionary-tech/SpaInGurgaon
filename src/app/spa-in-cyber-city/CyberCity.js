  ...
  const [isVisible, setIsVisible] = useState(false);
      useEffect(() => {
            ...
            const faqs = [
                  ...
                  {
                    question: "Do you offer hotel room massages in Cyber City?",
                    answer: " Yes, Spa in Gurgaon brings professional hotel room massage services to all the major 5-star hotels in Cyber City.",
                  ...
                  {
                    question: "Can I book a couple massage in Cyber City hotels?",
                    answer: "Yes, we do couple massage to guests in luxury hotels in Cyber City.",
                  ...
                  {
                        question: "What's the price range for a massage in Cyber City?",
...
icon: <Smile className="w-6 h-6 text-emerald-800" />,
  ...
  const hotelOutlets = [
  {
    ...
    description:
      "Spa in Gurgaon introduces therapeutic and relaxing massage to The Leela Ambience where nothing but everything appears good and serene. You will be in the hands of our certified therapists and they will ensure you are comfortable throughout. They apply warm oils, light movements and relaxing music that makes your stay at the hotel to become truly refreshing.",
  },
  {
    title: "Trident Gurgaon",
    image: "/images/hyatt-hotel.jpg",
    description:
      "Treat yourself to a great massage at Trident Gurgaon with our expert therapists. Whether it's deep tissue work or B2B massage, each session brings you balance, peace, and that luxury feeling you won't forget even after you check out.",
  },
  {
    title: "The Oberoi Gurgaon",
    image: "/images/R.jpg",
    description:
      "Our master therapists in Spa in Gurgaon also provide refreshing massages to your room in The Oberoi. Each session combines aromatherapy, warmth, and the appropriate degree of pressure to eliminate fatigue and improve the general mood.",
  },
  {
    title: "Crowne Plaza Gurgaon",
    image: "/images/278261524.jpg",
    description:
      "Get incredible relaxation at Crowne Plaza Gurgaon with our luxurious massage services. Our expert therapists make every session feel indulgent, harmonious, and completely peaceful from the moment it starts until it ends.",
  },
  {
    title: "Radisson Gurugram Udyog Vihar",
    image: "/images/pullmanAerocity.jpg",
    description:
      "Spa in Gurgaon also provides special massage programs at Cyber City hotels which are very effective in allowing a guest to have some quiet and personal time to rejuvenate. Each touch is also tailored to you to warm up and melt away tension, quiet your body, and awaken your senses like a fashionable wave of energy.",
  },
];
  const pricingPlans = [
    {
...
{/* End Our Process */}
  const services = [
    ...
    {
      title: "Thai Massage",
      description: "Our Thai massage in Cyber City puts together acupressure and stretching for complete body alignment. It releases stuck energy and gets your natural flexibility back in a peaceful setting.",
      icon: "🪨",
    },
    {
  ...
  },
  {
    id: 'couple',
    title: 'Couple Massage',
    desc: 'Shared, synchronised therapy for two — perfect for couples staying at Cyber City hotels.',
    duration: '60 / 90 mins',
    price: '₹3,499 - ₹4,999',
    icon: (
      <svg className="w-7 h-7" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
...
const SERVICES_RIGHT = [
  ...
  },
  {
    ...
    desc:
      "Book a massage whenever you need one. Our therapists can come on short notice to any of Cyber City's 5-star hotels, ready to bring that peaceful feeling to your room.",
    chips: ['The Leela', 'Trident', 'The Oberoi'],
    time: '3-6 hours',
    price: 'From ₹8,500',
...
const topSteps = [
    ...
    },
    {
      ...
      title: '24/7 Availability in Cyber City',
  ...
  const features = [
    ...
    { icon: HeartHandshake, title: "In‑Room Service", sub: "The Leela · Trident · The Oberoi" },
    ...
    {/* banner */}
          <section className="relative w-full h-[70vh] flex items-center justify-center">
                ...
                <Image
                  ...
                  alt="Luxury Body Spa Cyber City"
                  fill
                  priority
                ...
                >
                  <h1 className="text-4xl md:text-6xl font-bold text-white drop-shadow-lg">
                    About <span className="text-emerald-300">Our Outlets In Cyber City</span>
                  </h1>
      ...
      <div className="relative z-10 mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 px-4 py-16 md:py-24 lg:grid-cols-2">
        ...
        <div className="text-center lg:text-left">
          ...
          <h2 className="space-y-2 text-4xl font-light leading-tight text-gray-900 md:text-5xl">
            ...
            <span className="block font-medium">Cyber City to Enjoy <span className="text-rose-600">Relaxation</span></span>
          </h2>

          <p className="mx-auto mt-4 max-w-xl leading-relaxed text-gray-600 lg:mx-0">
            You know that feeling when the city just wears you down? That is where we come in. Spa in Gurgaon brings its trusted massage treatments right to Cyber City. We mix soothing touch, nice-smelling oils, and real relaxation into something that actually makes a difference. Whether you are here for work or just passing through, our <a href="/b2b-massage-in-gurgaon" className="text-emerald-700 font-medium underline hover:text-emerald-800">hotel spa services</a> take away the stress. You walk out feeling better, more centered, and actually refreshed.
          </p>

          {/* Service area chips */}
          <div className="mx-auto mt-8 grid max-w-md grid-cols-2 gap-4 lg:mx-0" role="list" aria-label="Service areas">
            {[
              { label: "Cyber City", icon: (
        ...
        <div className="relative h-80 md:h-96 lg:h-[450px]">
          <div className="absolute inset-0 overflow-hidden rounded-xl border-4 border-white shadow-2xl">
            <Image width={550} height={381} src="/images/RoseateHouse.jpg"
              alt="Serene spa ambience at a luxury Cyber City hotel in Gurgaon"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div 
                  ...
                  >
                    ...
                    >
                      Our Luxury Outlets <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-emerald-800">For Hotel Spa in Cyber City</span>
                    </motion.h2>
                    ...
                    >
                     We bring personalized spa treatments to the best 5-star hotels in Cyber City. Our professional therapists come straight to your hotel room with <a href="/massage-service-in-gurgaon" className="text-emerald-700 font-medium underline hover:text-emerald-800">premium massage services</a>. You get total relaxation without leaving your private space.
                    </motion.p>
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-6 md:grid-cols-2">
        ...
        >
          ...
          >
            <span className="mr-2">✦</span> About Our Cyber City Spa Outlets
          </motion.span>
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-14 text-center">
          ...
          >
            Our Hotel <span className="bg-gradient-to-r from-emerald-600 to-emerald-400 bg-clip-text text-transparent">Massage in Cyber City</span>
          </motion.h2>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            { k: 'inroom', label: 'In‑Room Service', sub: 'At leading Cyber City hotels' },
      ...
      <div className="mx-auto max-w-6xl">
        ...
        >
          <span className="text-xs font-semibold tracking-[0.25em] text-emerald-700">CYBER CITY · GURGAON OUTLET</span>
          ...
          <p className="mx-auto mt-4 max-w-3xl text-gray-600">
            Ease into serenity at our <a href="/spa-in-gurgaon" className="text-emerald-700 font-medium underline hover:text-emerald-800">Gurgaon</a> Cyber City outlet. Thoughtfully curated rituals, discreet in-room options, and
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-2">
          ...
          >
            ...
            <h3 className="font-serif text-2xl font-semibold text-emerald-800">Signature Cyber City Rituals</h3>
          ...
          >
            <div className="relative overflow-hidden rounded-2xl border border-[#e8d5c9] bg-white/70 shadow-2xl">
              <div className="relative h-[440px] w-full">
                <Image src="/images/best-western-merrion.jpg" alt="Serene spa ambience at Gurgaon Cyber City outlet" fill className="object-cover" />
              </div>
              {/* Overlay content */}
              ...
              <div className="absolute inset-x-0 bottom-0 flex items-center justify-between gap-4 p-4">
                <div>
                  <div className="font-serif text-lg font-semibold text-white">Gurgaon · Cyber City</div>
...
<section className="relative bg-gradient-to-b from-emerald-50 to-white px-6 py-20 md:px-16">
      <div className="mx-auto max-w-7xl">
        ...
        <motion.header
          ...
          className="mb-12 text-center"
        >
          <span className="text-xs font-semibold tracking-[0.25em] text-emerald-700">CYBER CITY HIGHLIGHTS</span>
          ...
          <p className="mx-auto mt-4 max-w-3xl text-[#4b3f3b]/80">
            Browse a few guest‑favorite experiences at our Cyber City outlet. Designed to help you reset fast—whenever you need it most.
          </p>
        </motion.header>
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-2">
          ...
          >
            <div className="grid grid-cols-2 gap-4">
              <div className="relative col-span-2 h-64 overflow-hidden rounded-2xl border border-[#e8d5c9]">
                <Image src="/images/fpkdl.com_960_1760686305_beautiful-young-woman-reciving-relxing-massage-massage-concept-body-massage-massage-health_299057-864.jpg" alt="Serene spa ambience at Cyber City" fill className="object-cover" />
              </div>
          ...
          <motion.div
            ...
            className="relative rounded-2xl border border-[#e8d5c9] bg-white/80 p-8 shadow-lg backdrop-blur-sm"
          >
            <h3 className="font-serif text-2xl font-semibold text-emerald-800">Why Guests Love Our Cyber City Outlet</h3>
    ...
    {/* content section */}
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-[#3a2e2a] mt-4 mb-4 font-serif">Why Choose Spa in Gurgaon as Best Centre for Massage in Cyber City</h2>
          <div className="mx-auto w-28 h-1 bg-emerald-600 rounded-full" />
          <p className="mt-4 text-gray-600 max-w-3xl mx-auto">
           Relaxation meets real expertise at Spa in Gurgaon. Here is why spa lovers in Cyber City keep choosing us.
          </p>
        </motion.div>
          ...
          <div className="space-y-8">
            ...
            >
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                  <h4 className="text-2xl font-bold">Book Relaxing Hotel Massage in Cyber City Today</h4>
                  <p className="mt-2 opacity-95">
                    Give your mind and body a break with the city's most trusted spa brand. Spa in Gurgaon's hotel massage services in Cyber City bring peace, comfort, and real care right to where you are. Book today and step into a world of serenity and pure relaxation.
                  </p>
                </div>
        ...
        >
          ...
          >
            Book a Personalized Journey
                        ...
                        {/* end */}
                        {/* how to book Cyber City spa outlets */}
        ...
        <header className="text-center mb-14">
          ...
          >
            <span className="block font-[Great_Vibes] text-4xl md:text-5xl text-emerald-800">
              How to Book Luxury Massage in Cyber City&apos;s
            </span>
      ...
      <div className="container mx-auto px-6 md:px-10 xl:px-20">
        ...
        >
          <h2 className="text-center text-3xl md:text-5xl font-serif font-extrabold text-emerald-900 leading-tight mb-6">
            Benefits of Booking Hotel Massage in Cyber City at Best Hotels
          </h2>
          ...
          <p className="text-xs text-gray-500 text-center mt-8">Available at selected premium hotels in Cyber City. Terms &amp; conditions apply.</p>
        </motion.div>
      </div>
    </section>
            ...
            <div className="max-w-7xl mx-auto relative z-10">
              ...
              <div className="text-center mb-16">
                ...
                <motion.h2
                  ...
                  transition={{ delay: 0.1 }}
                >
                  Our Pricing <span className="text-emerald-600">Package for Hotel Spa in Cyber City</span>
                </motion.h2>
                <motion.p
...
<motion.div
      ...
      >
        ...
        <p className="text-emerald-800 max-w-2xl text-lg">
          Here is what guests usually ask before they book their massage in Cyber City.
        </p>
  ...
  <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
    ...
    >
      <Image width={4000} height={6000} src="/images/woman-spending-time-spa-getting-exfoliation-massage.jpg"
        alt="Spa in Cyber City Gurgaon - frequently asked questions"
