  ...
  const services = [
    {
      ...
      description: (
        <>
          <a href="/b2b-massage-in-gurgaon" className="text-emerald-700 font-medium underline hover:text-emerald-800">B2B Massage</a> in Connaught Place, Gurgaon, spa offers both soft, sensual feeling with professional care, which causes soothing relaxation and total stress release.
        </>
      ),
      icon: "💆‍♂️",
    },
